...
const LessonManagement = () => {
    const { lessons, getAllLessons, createLesson, deleteLesson } = useLesson();
                    ...
                    >
                        <div className="p-4">
                            ...
                            <p className="text-sm text-gray-500 mt-1">
                                Class ID: {lesson.classId}
                            </p>
                            <p className="text-sm text-gray-500 mt-1">
                                Created By: {lesson?.createdBy || 'Unknown'}
                            </p>
                        </div>
                        <div className="p-2 bg-gray-50 border-t border-gray-200 flex justify-end gap-2">
                            ...
                            <Button variant="primary" onClick={() => alert('Edit Lesson')}>
                                Edit
                            </Button>
                            <Button
                                variant="secondary"
