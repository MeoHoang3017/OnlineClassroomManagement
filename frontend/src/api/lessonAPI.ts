...
const LessonAPI = {
    ...
    createLesson: (lesson: CreateLessonRequest) => authorApi.post('/lessons/create', lesson).then(response => response.data),
    ...
    getLessonByClassId: (id: string) => authorApi.get(`/lessons/class/${id}`).then(response => response.data),
}
